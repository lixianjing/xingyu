...
public class WBAccountManager {
    ...
    public void getUserThumbIcon(String uri) {
        ...
        final byte[] data = BaseUtil.getImageData(mContext, uri);
        if (data != null && data.length > 0) {
            ...
            if (bitmap != null) {
                ...
                Message message = mHanlder.obtainMessage(MainActivity.MSG_LOGIN_GET_ICON_SUCCESS);
                message.obj = bitmap;
                message.sendToTarget();
                return;
            }
    ...
    public void loadAccount(String openid, String accessToken, long expiresIn) {
        // TODO Auto-generated method stub
        mAccessToken = new Oauth2AccessToken(accessToken, String.valueOf(expiresIn));
